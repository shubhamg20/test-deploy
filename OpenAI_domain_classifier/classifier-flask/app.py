...
def analyze_text(text):
    ...
    # 'Greetings', 'Backstory', 'Justification', 'Rant', 'Gratitude', 'Other', 'ExpressEmotion. \
    # The sentence is delimitted with tripple backticks \
    # sentence: ```{sentence}```. your output should be the list of labels without any punctuation and other special chracters.\
    ...
    # labels: [Greetings, Backstory, Rant, Gratitude]
    ...
    # labels: [Backstory, Gratitude, Other]
    # Example5-
    ...
    # labels: [Backstory, Justification]
    # Example6-
    ...
    # labels: [Backstory, ExpressEmotion]
    # Example7-
    ...
    prompt = f"""Identify the category of the given sentence from the following options:   \
    ...
    The sentence is delimitted with tripple backticks \
    sentence: ```{text}```. your output can only have the label as given above without encapsulating it in inverted commas """
